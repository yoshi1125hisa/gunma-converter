...
convertbtn.onclick = () => {
    ...
    const href = "https://twitter.com/intent/tweet?button_hashtag=" + encodeURIComponent('いばらき変換') + "&ref_src=twsrc%5Etfw";
    anchor.setAttribute('href', href);
    anchor.className = "twitter-hashtag-button";
    anchor.setAttribute('data-text', convertedtext);
    anchor.innerText = 'Tweet #いばらき変換';
